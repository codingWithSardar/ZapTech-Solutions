  ...
  return (
    <main className="relative overflow-hidden bg-[#030817] text-white">
      <section className="relative min-h-[85vh] overflow-hidden px-6 pb-24 pt-36 sm:pt-40 lg:px-8">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(6,182,212,0.12),transparent_30%),radial-gradient(circle_at_10%_70%,rgba(37,99,235,0.08),transparent_30%),radial-gradient(circle_at_90%_20%,rgba(124,58,237,0.08),transparent_30%)]" />
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-[45%] h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-400/[0.05]"
        />
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-[45%] h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-violet-400/[0.04]"
        />
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="max-w-5xl text-5xl font-black leading-[0.98] tracking-[-0.05em] sm:text-6xl lg:text-8xl"
          >
            We Build Digital
          ...
          >
            <a
              href="/projects"
              className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500 px-6 py-3.5 text-sm font-bold text-white shadow-[0_10px_40px_rgba(37,99,235,0.18)] transition-transform duration-300 hover:scale-[1.03]"
            >
              Explore Our Work
            ...
            <a
              href="/contact"
              className="flex items-center justify-center gap-2 rounded-xl border border-white/[0.1] bg-white/[0.03] px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/20 hover:bg-white/[0.06]"
            >
      ...
      <section className="relative px-6 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-2">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="group relative overflow-hidden rounded-[28px] border border-white/[0.08] bg-gradient-to-br from-cyan-400/[0.07] to-white/[0.02] p-8 backdrop-blur-xl sm:p-10"
          >
            <div className="absolute -right-20 -top-20 h-48 w-48 rounded-full bg-cyan-400/[0.08] blur-[70px]" />

            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-cyan-400/20 bg-cyan-400/[0.06]">
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-[28px] border border-white/[0.08] bg-gradient-to-br from-violet-400/[0.07] to-white/[0.02] p-8 backdrop-blur-xl sm:p-10"
          >
            <div className="absolute -bottom-20 -right-20 h-48 w-48 rounded-full bg-violet-400/[0.08] blur-[70px]" />

            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-violet-400/20 bg-violet-400/[0.06]">
      ...
      <section className="relative border-y border-white/[0.06] bg-white/[0.015] px-6 py-20 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <motion.h2
              ...
              className="mt-5 text-4xl font-black tracking-[-0.04em] sm:text-5xl"
            >
              More Than A
              <span className="block bg-gradient-to-r from-cyan-300 via-blue-400 to-violet-400 bg-clip-text text-transparent">
                Development Agency.
            ...
            {capabilities.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className="group relative overflow-hidden rounded-[24px] border border-white/[0.08] bg-gradient-to-br from-white/[0.05] to-white/[0.015] p-7 backdrop-blur-xl transition-colors duration-500 hover:border-cyan-400/15"
                >
                  <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-cyan-400/[0.04] blur-3xl transition-all duration-500 group-hover:bg-cyan-400/[0.08]" />
                  ...
                  <div className="relative">
                    ...
                    <ArrowRight
                      size={17}
                      className="mt-6 text-slate-700 transition-all duration-300 group-hover:translate-x-2 group-hover:text-cyan-300"
                    />
                  </div>
                </motion.div>
              );
      ...
      <section className="relative px-6 pb-28 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative mx-auto max-w-6xl overflow-hidden rounded-[30px] border border-white/[0.08] bg-gradient-to-r from-cyan-400/[0.06] via-blue-500/[0.05] to-violet-500/[0.06] px-7 py-12 text-center sm:px-12 sm:py-16"
        >
